    ...
    function(e, t, n) {
        ...
        default.maps,
            ...
            default.store.set("vlx", Date.now()),
                ...
                n = new t;
                if (E.url = decodeURI(e.config.path), E.insertedAt = new Date, C.rid) {
                    var r = C.pid || C.rid;
                    n.set("rid", C.rid),
                    n.set("pid", r),
                    E.comment = j.replace("<p>", '<p><a class="at" href="#' + r + '">' + C.at + "</a> , ")
                }
                ...
                default.store.set(h.MetaCacheKey, {
                    ...
                    try {
                        C.rid ? I(t, (0, y.
                    default)('.vquote[data-self-id="' + C.rid + '"]'), !0) : (Number(n.text()) ? n.text(Number(n.text()) + 1) : e.$el.find(".vcount").show().find(".vnum").text(Number(n.text()) + 1), I(t, e.$el.find(".vcards")), k.skip++),
...
*/
            ...
            * storejs v1.0.24 * Local storage localstorage package provides a simple API * *Copyright(c) 2018 kenny wang < wowohoo@qq.com > *https: //github.com/jaywcjlove/store.js
...
function(e, t) {
    e.exports = {
        nick: "昵称(QQ号)",
        mail: "邮箱(昵称填QQ号就能自动识别了噢)",
        link: "网址(可有可无懂的都懂)(http://)",
        nickFail: "昵称不能少于3个字符",
        mailFail: "请填写正确的邮件地址",
        sofa: "来发评论吧~",
        submit: "提交",
